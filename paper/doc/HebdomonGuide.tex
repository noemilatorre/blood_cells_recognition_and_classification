...
Si è mantenuta come principale metrica di valutazione l'\textbf{F1-Score Macro}, che ha raggiunto nel primo stadio un valore di \hlight{0.75} e nel secondo stadio un valore di \hlight{0.32}. Questi risultati (tabella \ref{tab:full_report}) indicano una buona capacità del modello di distinguere tra le cellule sane e quelle infette, nonché tra le diverse sottoclassi di cellule infette.
